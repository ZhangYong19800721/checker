...
trainset_file = open(r"./data/corpus_trainset_consistent_digit.cps", "rb")  # 打开数据集文件
...
trainset_file_consistent_rmrepeat = open(r"./data/corpus_trainset_consistent_rmrepeat_digit.cps", "wb")  # 打开数据集文件
