...
class ArticleReviewer(nn.Module):
    def __init__(self, input_size, hidden_size, embedding, num_layers=1, dropout=0):
        ...
        self.fc_attention1 = nn.Linear(2 * hidden_size, 2 * hidden_size)  # attention层的线性变换
    ...
    def forward(self, article, article_len, hidden=None):
        ...
        # Attention Layer
        atten = torch.sigmoid(self.fc_attention1(outputs_gru)) - 0.5
        ...
        repeat_score = torch.stack([score] * 2 * self.hidden_size, dim=2)
