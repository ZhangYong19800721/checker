...
# 读入训练集
corpus_trainset_file = open(r"D:\FTPROOT\workspace3\data\corpus_trainset.cps", "rb")
corpus_trainset = pickle.load(corpus_trainset_file)
corpus_trainset_file.close()

# 读入测试集
corpus_testset_file = open(r"D:\FTPROOT\workspace3\data\corpus_testset.cps", "rb")
corpus_testset = pickle.load(corpus_testset_file)
corpus_testset_file.close()

# 读入词汇表
vocabulary_file = open(r"D:\FTPROOT\workspace3\data\vocabulary.voc", "rb")
...
corpus_trainset_digit_file = open(r"D:\FTPROOT\workspace3\data\corpus_trainset_digit.cps", "wb")
corpus_testset_digit_file = open(r"D:\FTPROOT\workspace3\data\corpus_testset_digit.cps", "wb")
